...
The `home-routes` handler in the `github-project-watch.routes.home` namespace
...
The `home-page` function will in turn call the `github-project-watch.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `github-project-watch.handler` namespace:
...
Request middleware functions are located under the `github-project-watch.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `github-project-watch.dev-middleware` namespace found in
